...
/* Make description tab full width */
.resp-tabs-container {
    width: 100%;
}
                        ...
                        <div class="flexslider1">
                           <ul class="slides">
                              ...
                              <li data-thumb="images/<?php echo $row['Image1'];?>">
                                 <div class="thumb-image"> <img src="images/<?php echo $row['Image1'];?>" data-imagezoom="true" class="img-fluid" alt=" "> 
                                 </div>
                              </li>
                           <?php endif;?>
                             <?php if($row['Image2']!=''): ?>
                              <li data-thumb="images/<?php echo $row['Image2'];?>">
                                 <div class="thumb-image"> <img src="images/<?php echo $row['Image2'];?>" data-imagezoom="true" class="img-fluid" alt=" "> </div>
                              </li>
            <?php endif;?>
                             <?php if($row['Image3']!=''): ?>
                                 <li data-thumb="images/<?php echo $row['Image3'];?>">
                                 <div class="thumb-image"> <img src="images/<?php echo $row['Image3'];?>" data-imagezoom="true" class="img-fluid" alt=" "> </div>
                              </li>
            <?php endif;?>
                             <?php if($row['Image4']!=''): ?>
                                 <li data-thumb="images/<?php echo $row['Image4'];?>">
                                 <div class="thumb-image"> <img src="images/<?php echo $row['Image4'];?>" data-imagezoom="true" class="img-fluid" alt=" "> </div>
                              </li>
                                          <?php endif;?>
                                          <?php if($row['Image5']!=''): ?>
                                 <li data-thumb="images/<?php echo $row['Image5'];?>">
                                 <div class="thumb-image"> <img src="images/<?php echo $row['Image5'];?>" data-imagezoom="true" class="img-fluid" alt=" "> </div>
                              </li>
                                          <?php endif;?>
                                          <?php if($row['Image6']!=''): ?>
                                 <li data-thumb="images/<?php echo $row['Image6'];?>">
                                 <div class="thumb-image"> <img src="images/<?php echo $row['Image6'];?>" data-imagezoom="true" class="img-fluid" alt=" "> </div>
                              </li>
                                          <?php endif;?>
                                          <?php if($row['Image7']!=''): ?>
                                 <li data-thumb="images/<?php echo $row['Image7'];?>">
                                 <div class="thumb-image"> <img src="images/<?php echo $row['Image7'];?>" data-imagezoom="true" class="img-fluid" alt=" "> </div>
                              </li>
                                          <?php endif;?>
                                          <?php if($row['Image8']!=''): ?>
                                 <li data-thumb="images/<?php echo $row['Image8'];?>">
                                 <div class="thumb-image"> <img src="images/<?php echo $row['Image8'];?>" data-imagezoom="true" class="img-fluid" alt=" "> </div>
                              </li>
                                          <?php endif;?>
                  ...
                  <div class="col-lg-8 single-right-left simpleCart_shelfItem">
                     ...
                     <div class="occasional">
                       ...
                       <h5><strong>Price :</strong> ₹<?php echo $row['SellingPricing']; ?></h5>
