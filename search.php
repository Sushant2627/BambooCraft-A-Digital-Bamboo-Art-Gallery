...
<html lang="zxx">
   <head>
      <title>BambooCraft – A Digital Bamboo Art Gallery | Product Page</title>
...
?>
               ...
               <div class="left-ads-display col-lg-9">
                  <div class="row">
                  <?php
$searchinput = isset($_POST['search']) ? mysqli_real_escape_string($con, $_POST['search']) : '';
if (empty($searchinput)) {
    echo "<h3 align='center' style='color:red;'>Please enter a search query</h3>";
    exit();
}
                        ...
                        <div class="product-toys-info">
                           <div class="men-pro-item">
                              <div class="men-thumb-item">
                                 <img src="images/<?php echo $row['Image'];?>" class="img-thumbnail" alt="">
