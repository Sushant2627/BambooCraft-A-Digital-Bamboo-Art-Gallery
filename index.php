   ...
   <body>
      ...
      <section class="about py-lg-4 py-md-3 py-sm-3 py-3" id="about">
         <div class="container py-lg-5 py-md-5 py-sm-4 py-4">
            ...
            <?php
   $ret = mysqli_query($con, "SELECT id, Title, Image FROM tblartproduct ORDER BY id ASC LIMIT 9");
   while ($row = mysqli_fetch_array($ret)) {
       $imagePath = "images/" . htmlspecialchars($row['Image']);
?>
       <div class="col-lg-4 col-md-6 col-sm-6 text-center banner-agile-flowers product-container">
           <img src="<?php echo $imagePath; ?>" width="180" height="180" style="margin-top: 40px;" alt="<?php echo htmlspecialchars($row['Title']); ?>">
           <div class="banner-right-icon">
               <h4 class="pt-3"><?php echo htmlspecialchars($row['Title']); ?></h4>
           </div>
       </div>
<?php 
   } 
      ...
      <section class="blog py-lg-4 py-md-3 py-sm-3 py-3">
         <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
            ...
            <div class="slid-img">
               <ul id="flexiselDemo1">
               <?php
$ret = mysqli_query($con, "SELECT tblarttype.ID as atid, tblarttype.ArtType as typename, 
                           tblartproduct.ID as apid, tblartproduct.Title, tblartproduct.Image, 
                           tblartproduct.ArtType 
                           FROM tblartproduct 
                           JOIN tblarttype ON tblarttype.ID = tblartproduct.ArtType 
                           ORDER BY tblartproduct.ID ASC LIMIT 8");
...
?>
                  <li>
                     ...
                     <div class="agileinfo_port_grid">
                        <img src="images/<?php echo $row['Image'];?>" width="300" height="300" alt=" " />
                        <div class="banner-right-icon">
